...
urlpatterns = patterns('',
    ...
    url(r'^election/(?P<election_slug>[-_a-z0-9]+)/vote/$', 'referenda.views.voter_login', name='referenda.voter_login'),
    url(r'^election/(?P<election_slug>[-_a-z0-9]+)/submit/$', 'referenda.views.submit_ballot', name='referenda.submit_ballot'),
    url(r'^election/(?P<election_slug>[-_a-z0-9]+)/content/$', 'referenda.views.ballot_content', name='referenda.ballot_content'),
)
