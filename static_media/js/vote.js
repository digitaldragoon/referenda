...
REFERENDA.Ballot = Class.extend({
    toJSON: function() {
        return $('#enc_plaintext_ballot').val();
    }
});

REFERENDA.Session = Class.extend({
    init: function() {
        this.ballot = new REFERENDA.Ballot();
    },
...
REFERENDA.Controller = Class.extend({
    init: function() {
        this.session = new REFERENDA.Session();
    },
    /* Display a notification to the user */
    display_message: function (message, node) {
    ...
    navigate_to_panel: function(panel_id) {
    ...
    navigate_to_next_panel: function() {
    ...
    /* Select a candidate */
    select_candidate: function(candidate) {
    ...
    race_choices_left: function(race) {
    ...
    update_candidates_from_ballot: function() {
        /*FIXME - implement*/
    },
    
    /* update finalize page */
    update_finalize: function() {
        var control = this;
    ...
    compute_single_ballot: function (race) {
        var id = control.get_race_id(race);
        var result = {};
        result[id] = new Array();
    ...
    submit_ballot: function() {
        ...
        var data = {
            ...
            ballot:  this.session.ballot.toJSON(),
    ...
    handle_submit_error: function(data) {
        var pane = $('#submission-pane');
        pane.empty();
...
/* Initialize */
var control = new REFERENDA.Controller();
